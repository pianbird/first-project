...
from config.constants import DEFAULT_MAX_ACCOUNT_EXPOSURE
try:
...
class OrderGuard:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.max_account_exposure = risk_cfg.get("max_account_exposure", DEFAULT_MAX_ACCOUNT_EXPOSURE) # 기본 5,000만원
